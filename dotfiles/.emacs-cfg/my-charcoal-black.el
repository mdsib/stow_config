...
(defun color-theme-alt-charcoal ()
  "Color theme by mds, created 2017-04-23."
  (interactive)
  (color-theme-install
   '(color-theme-alt-charcoal
     ...
     (default ((t (:stipple nil :background "Grey15" :foreground "Grey" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 112 :width normal :foundry "PfEd" :family "DejaVu Sans Mono"))))
     (Info-quoted ((t (:family "courier"))))
     (Man-overstrike ((t (:bold t :weight bold))))
     (Man-reverse ((t (:foreground "light blue" :background "dark slate blue"))))
     ...
     (woman-bold ((t (:bold t :weight bold :foreground "sky blue" :weight))))
     (woman-bold-face ((t (:bold t :weight bold :foreground "sky blue" :weight))))
     (woman-italic ((t (:foreground "deep sky blue"))))
     (woman-italic-face ((t (:foreground "deep sky blue"))))
     (woman-unknown ((t (:bold t :weight bold :foreground "LightSalmon"))))
     (woman-unknown-face ((t (:bold t :weight bold :foreground "LightSalmon"))))
     (yas--field-debug-face ((t (nil))))
     (yas-field-highlight-face ((t (:background "DarkSlateBlue"))))
     (zmacs-region ((t (:background "DarkSlateBlue")))))))
(add-to-list 'color-themes '(color-theme-alt-charcoal  "alt charcoal" "mds"))
